...
|  9      |  i = 9/2 * 7.5  |  33.75        |  I = 4,5a            | LVx = 10 * cos[(-12a + 4,5a)]  |          |
|  10     |  i = 10/2 * 7.5 |  37.5         |  I = 5a              | LVx = 10 * cos[(-12a + 5a)]    |          |
|  11     |  i = 11/2 * 7.5 |  41.25        |  I = 5,5a            | LVx = 10 * cos[(-12a + 5,5a)]  |          |
|  12     |  i = 12/2 * 7.5 |  45           |  I = 6a              | LVx = 10 * cos[(-12a + 6a)]    |          |
|  13     |  i = 13/2 * 7.5 |  48.75        |  I = 6,5a            | LVx = 10 * cos[(-12a + 6,5a)]  |          |
|  14     |  i = 14/2 * 7.5 |  52.5         |  I = 7a              | LVx = 10 * cos[(-12a + 7a)]    |          |
|  15     |  i = 15/2 * 7.5 |  56.25        |  I = 7,5a            | LVx = 10 * cos[(-12a + 7,5a)]  |          |
|  16     |  i = 16/2 * 7.5 |  60           |  I = 8a              | LVx = 10 * cos[(-12a + 8a)]    |          |
|  17     |  i = 17/2 * 7.5 |  63.75        |  I = 8,5a            | LVx = 10 * cos[(-12a + 8,5a)]  |          |
|  18     |  i = 18/2 * 7.5 |  67.5         |  I = 9a              | LVx = 10 * cos[(-12a + 9a)]    |          |
|  19     |  i = 19/2 * 7.5 |  71.25        |  I = 9,5a            | LVx = 10 * cos[(-12a + 9,5a)]  |          |
|  20     |  i = 20/2 * 7.5 |  75           |  I = 10a             | LVx = 10 * cos[(-12a + 10a)]   |          |
|  21     |  i = 21/2 * 7.5 |  78.75        |  I = 10,5a           | LVx = 10 * cos[(-12a + 10,5a)] |          |
|  22     |  i = 22/2 * 7.5 |  82.5         |  I = 11a             | LVx = 10 * cos[(-12a + 11a)]   |          |
|  23     |  i = 23/2 * 7.5 |  86.25        |  I = 11,5a           | LVx = 10 * cos[(-12a + 11,5a)] |          |
|  24     |  i = 24/2 * 7.5 |  90           |  I = 12a             | LVx = 10 * cos[(-12a + 12a)]   |          |
