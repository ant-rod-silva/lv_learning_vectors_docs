...
|---------|-----------------|---------------|----------------------|--------------------------------|--------------------|--------|
|  0      |  i = 0/2 * 7.5  |  0            |  I = 0a              | LVx = 10 * cos[(-12a + 0a)]    | 0                  | 0.0    |
|  1      |  i = 1/2 * 7.5  |  3.75         |  I = 0,5a            | LVx = 10 * cos[(-12a + 0,5a)]  | 0.6540312923014304 | 0.7    |
...
|  6      |  i = 6/2 * 7.5  |  22.5         |  I = 3a              | LVx = 10 * cos[(-12a + 3a)]    | 3.8268343236508984 | 3.21   |
|  7      |  i = 7/2 * 7.5  |  26.25        |  I = 3,5a            | LVx = 10 * cos[(-12a + 3,5a)]  | 4.422886902190013  | 3.21   |
|  8      |  i = 8/2 * 7.5  |  30           |  I = 4a              | LVx = 10 * cos[(-12a + 4a)]    | 5.000000000000001  | 3.21   |
|  9      |  i = 9/2 * 7.5  |  33.75        |  I = 4,5a            | LVx = 10 * cos[(-12a + 4,5a)]  | 5.555702330196023  | 3.21   |
|  10     |  i = 10/2 * 7.5 |  37.5         |  I = 5a              | LVx = 10 * cos[(-12a + 5a)]    | 6.087614290087206  | 3.21   |
|  11     |  i = 11/2 * 7.5 |  41.25        |  I = 5,5a            | LVx = 10 * cos[(-12a + 5,5a)]  | 6.593458151000688  | 3.21   |
|  12     |  i = 12/2 * 7.5 |  45           |  I = 6a              | LVx = 10 * cos[(-12a + 6a)]    | 7.0710678118654755 | 3.21   |
|  13     |  i = 13/2 * 7.5 |  48.75        |  I = 6,5a            | LVx = 10 * cos[(-12a + 6,5a)]  | 7.518398074789774  | 3.21   |
|  14     |  i = 14/2 * 7.5 |  52.5         |  I = 7a              | LVx = 10 * cos[(-12a + 7a)]    | 7.933533402912351  | 3.21   |
|  15     |  i = 15/2 * 7.5 |  56.25        |  I = 7,5a            | LVx = 10 * cos[(-12a + 7,5a)]  | 8.314696123025453  | 3.21   |
|  16     |  i = 16/2 * 7.5 |  60           |  I = 8a              | LVx = 10 * cos[(-12a + 8a)]    | 8.660254037844387  | 3.21   |
|  17     |  i = 17/2 * 7.5 |  63.75        |  I = 8,5a            | LVx = 10 * cos[(-12a + 8,5a)]  | 8.968727415326882  | 3.21   |
|  18     |  i = 18/2 * 7.5 |  67.5         |  I = 9a              | LVx = 10 * cos[(-12a + 9a)]    | 9.238795325112868  | 3.21   |
|  19     |  i = 19/2 * 7.5 |  71.25        |  I = 9,5a            | LVx = 10 * cos[(-12a + 9,5a)]  | 9.469301294951057  | 3.21   |
|  20     |  i = 20/2 * 7.5 |  75           |  I = 10a             | LVx = 10 * cos[(-12a + 10a)]   | 9.659258262890683  | 3.21   |
|  21     |  i = 21/2 * 7.5 |  78.75        |  I = 10,5a           | LVx = 10 * cos[(-12a + 10,5a)] | 9.807852804032304  | 3.21   |
|  22     |  i = 22/2 * 7.5 |  82.5         |  I = 11a             | LVx = 10 * cos[(-12a + 11a)]   | 9.914448613738104  | 3.21   |
|  23     |  i = 23/2 * 7.5 |  86.25        |  I = 11,5a           | LVx = 10 * cos[(-12a + 11,5a)] | 9.978589232386035  | 3.21   |
|  24     |  i = 24/2 * 7.5 |  90           |  I = 12a             | LVx = 10 * cos[(-12a + 12a)]   | 10.0               | 3.21   |
