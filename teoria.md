...
- Assumindo 25 valores (0 a 24, n = 24 partes), então 90/24 = 3.25°.
...
|:---|:-------------------------|:--------------|:-------------------------------|:-------------------|:-------|
| 0  | (n/2) * α → (0/2) * 7.5  |  0            | LVx = 10 * cos[(-12a + 0a)]    | 0                  | 0.00   |
| 1  | (n/2) * α → (1/2) * 7.5  |  3.75         | LVx = 10 * cos[(-12a + 0,5a)]  | 0.6540312923014304 | 0.65   |
| 2  | (n/2) * α → (2/2) * 7.5  |  7.5          | LVx = 10 * cos[(-12a + a)]     | 1.305261922200517  | 1.31   |
| 3  | (n/2) * α → (3/2) * 7.5  |  11.25        | LVx = 10 * cos[(-12a + 1,5a)]  | 1.9509032201612833 | 1.95   |
| 4  | (n/2) * α → (4/2) * 7.5  |  15           | LVx = 10 * cos[(-12a + 2a)]    | 2.5881904510252074 | 2.59   |
| 5  | (n/2) * α → (5/2) * 7.5  |  18.75        | LVx = 10 * cos[(-12a + 2,5a)]  | 3.2143946530316168 | 3.21   |
| 6  | (n/2) * α → (6/2) * 7.5  |  22.5         | LVx = 10 * cos[(-12a + 3a)]    | 3.8268343236508984 | 3.83   |
| 7  | (n/2) * α → (7/2) * 7.5  |  26.25        | LVx = 10 * cos[(-12a + 3,5a)]  | 4.422886902190013  | 4.42   |
| 8  | (n/2) * α → (8/2) * 7.5  |  30           | LVx = 10 * cos[(-12a + 4a)]    | 5.000000000000001  | 5.00   |
| 9  | (n/2) * α → (9/2) * 7.5  |  33.75        | LVx = 10 * cos[(-12a + 4,5a)]  | 5.555702330196023  | 5.56   |
| 10 | (n/2) * α → (10/2) * 7.5 |  37.5         | LVx = 10 * cos[(-12a + 5a)]    | 6.087614290087206  | 6.09   |
| 11 | (n/2) * α → (11/2) * 7.5 |  41.25        | LVx = 10 * cos[(-12a + 5,5a)]  | 6.593458151000688  | 6.59   |
| 12 | (n/2) * α → (12/2) * 7.5 |  45           | LVx = 10 * cos[(-12a + 6a)]    | 7.0710678118654755 | 7.07   |
| 13 | (n/2) * α → (13/2) * 7.5 |  48.75        | LVx = 10 * cos[(-12a + 6,5a)]  | 7.518398074789774  | 7.52   |
| 14 | (n/2) * α → (14/2) * 7.5 |  52.5         | LVx = 10 * cos[(-12a + 7a)]    | 7.933533402912351  | 7.93   |
| 15 | (n/2) * α → (15/2) * 7.5 |  56.25        | LVx = 10 * cos[(-12a + 7,5a)]  | 8.314696123025453  | 8.31   |
| 16 | (n/2) * α → (16/2) * 7.5 |  60           | LVx = 10 * cos[(-12a + 8a)]    | 8.660254037844387  | 8.66   |
| 17 | (n/2) * α → (17/2) * 7.5 |  63.75        | LVx = 10 * cos[(-12a + 8,5a)]  | 8.968727415326882  | 8.97   |
| 18 | (n/2) * α → (18/2) * 7.5 |  67.5         | LVx = 10 * cos[(-12a + 9a)]    | 9.238795325112868  | 9.24   |
| 19 | (n/2) * α → (19/2) * 7.5 |  71.25        | LVx = 10 * cos[(-12a + 9,5a)]  | 9.469301294951057  | 9.47   |
| 20 | (n/2) * α → (20/2) * 7.5 |  75           | LVx = 10 * cos[(-12a + 10a)]   | 9.659258262890683  | 9.66   |
| 21 | (n/2) * α → (21/2) * 7.5 |  78.75        | LVx = 10 * cos[(-12a + 10,5a)] | 9.807852804032304  | 9.81   |
| 22 | (n/2) * α → (22/2) * 7.5 |  82.5         | LVx = 10 * cos[(-12a + 11a)]   | 9.914448613738104  | 9.91   |
| 23 | (n/2) * α → (23/2) * 7.5 |  86.25        | LVx = 10 * cos[(-12a + 11,5a)] | 9.978589232386035  | 9.98   |
| 24 | (n/2) * α → (24/2) * 7.5 |  90           | LVx = 10 * cos[(-12a + 12a)]   | 10.0               | 10.00  |
